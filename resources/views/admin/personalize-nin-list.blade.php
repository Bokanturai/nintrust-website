...
@section('title', 'Personalize NIN List')
                ...
                <div class="col-xl-12">
                    <div class="card custom-card ">
                        <div class="card-header">
                            <h5 class="card-title">Personalize NIN Requests</h5>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form method="GET" action="{{ route('admin.personalize-nin.index') }}"
                                class="row g-2 mb-3 align-items-end">
                                <div class="col-md-3">
                                    <input type="text" name="search" class="form-control"
                                        value="{{ request('search') }}" placeholder="Search Reference, Name, Tracking ID...">
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <tbody>
                                        @foreach ($records as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.personalize-nin.view', [$row->id, $request_type]) }}"
