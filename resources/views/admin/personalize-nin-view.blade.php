...
@section('title', 'Personalize NIN Request View')
@push('styles')
                ...
                <div class="col-xl-12">
                    <div class="card custom-card ">
                        <div class="card-header">
                            <h5 class="card-title">Personalize NIN Request</h5>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                                    ...
                                    <div class="card shadow-sm border-0">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    <div class="p-3 border rounded bg-light">
                                                        ...
                                                        <p><strong>Service Type:</strong> Personalize NIN</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row p-3 border rounded bg-light mb-4">
                                                <div class="col-md-12">
                                                    <h6 class="text-uppercase text-muted mb-3">Submission Details</h6>
                                                    <p><strong>Reference No.:</strong>
                                                        {{ strtoupper($requests->refno ?? 'N/A') }}</p>
                                                    <p><strong>Tracking ID:</strong> {{ $requests->tracking_id ?? 'N/A' }}</p>
                                            ...
                                            <div class="p-3 border rounded bg-light mt-5">
                                                ...
                                                <form
                                                    action="{{ route('admin.update-personalize-nin-status', [$requests->id, $request_type]) }}"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            statusSelect.addEventListener('change', function() {
                ...
                if (this.value === 'processing') {
                    ...
                    quill.root.innerHTML = "Your Personalize NIN request has been successfully resolved.";
                }
            });
