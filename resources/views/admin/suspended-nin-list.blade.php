...
@section('title', 'Suspended NIN List')
                ...
                <div class="col-xl-12">
                    <div class="card custom-card ">
                        <div class="card-header">
                            <h5 class="card-title">Suspended NIN Requests</h5>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form method="GET" action="{{ route('admin.suspended-nin.index') }}"
                                    ...
                                    <tbody>
                                        @foreach ($records as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.suspended-nin.view', [$row->id, $request_type]) }}"
