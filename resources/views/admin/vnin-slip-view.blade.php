...
@section('title', 'VNIN Slip Request View')
@push('styles')
                ...
                <div class="col-xl-12">
                    <div class="card custom-card ">
                        <div class="card-header">
                            <h5 class="card-title">VNIN Slip Request</h5>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                                    ...
                                    <div class="card shadow-sm border-0">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    <div class="p-3 border rounded bg-light">
                                                        ...
                                                        <p><strong>Service Type:</strong> VNIN Slip</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-3 border rounded bg-light mt-5">
                                                ...
                                                <form
                                                    action="{{ route('admin.update-vnin-slip-status', [$requests->id, $request_type]) }}"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            statusSelect.addEventListener('change', function() {
                ...
                if (this.value === 'processing') {
                    ...
                    quill.root.innerHTML = "Your VNIN Slip request has been successfully resolved.";
                }
            });
