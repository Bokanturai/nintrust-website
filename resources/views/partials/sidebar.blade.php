<nav class="sidebar sidebar-offcanvas mt-0"
     id="sidebar">
    ...
    <div class="sidebar-profile p-3 text-center">
        ...
        @else
            <i class="bi bi-person-circle"
               style="font-size: 3rem; color: #fff;"></i>
        @endif
    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::is('user.wallet') ? 'active' : '' }}"
        ...
        {{-- <li class="nav-item">
            <a class="nav-link {{ Route::is('user.airtime') ? 'active' : '' }}"
               href="{{ route('user.airtime') }}">
        ...
        {{-- <li class="nav-item">
            <a class="nav-link {{ Route::is('user.data') ? 'active' : '' }}"
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::is('user.verify-nin-phone') ? 'active' : '' }}"
               href="{{ route('user.verify-nin-phone') }}">
                <i class="mdi mdi-phone menu-icon"></i>
                <span class="menu-title">NIN PHONE</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::is('user.ipe') ? 'active' : '' }}"
               href="{{ route('user.ipe') }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::is('user.nin.mod') ? 'active' : '' }}"
               href="{{ route('user.nin.mod') }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::is('user.suspended-nin.form') ? 'active' : '' }}"
               href="{{ route('user.suspended-nin.form') }}">
                <i class="mdi mdi-pencil-lock-outline menu-icon"></i>
                <span class="menu-title">Suspended NIN</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::is('user.scratch_cards.index') ? 'active' : '' }}"
               href="{{ route('user.scratch_cards.index') }}">
                ...
                <span class="menu-title">Buy Scratch Card</span>
            </a>
        </li>
        ...
        @if (auth()->user()->role == 'admin')
            <li class="nav-item">
                <a href="#"
                   class="nav-link"
                   onclick="toggleSubmenu(event, 'adminSubmenu')">
                    <i class="mdi mdi-cog-outline menu-icon"></i>
                    <span class="menu-title">Manage</span>
                    <i class="mdi mdi-chevron-down ms-auto"></i>
                </a>
                <ul class="sub-menu nav flex-column ps-4"
                    id="adminSubmenu">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.enroll.index') ? 'active' : '' }}"
                           href="{{ route('admin.enroll.index') }}">
                            <i class="mdi mdi-pencil menu-icon"></i>BVN User
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.suspended-nin.index') ? 'active' : '' }}"
                           href="{{ route('admin.suspended-nin.index') }}">
                            <i class="mdi mdi-pencil-lock-outline menu-icon"></i>Suspended NIN
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.scratch_cards.index') ? 'active' : '' }}"
                           href="{{ route('admin.scratch_cards.index') }}">
                            <i class="mdi mdi-ticket-confirmation menu-icon"></i>Scratch Cards
                        </a>
                    </li>
