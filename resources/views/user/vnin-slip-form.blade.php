...
@section('title', 'VNIN Slip Request')
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center my-3">
                        <h4 class="fw-bold mb-0">VNIN Slip Request</h4>
                    ...
                    <div class="alert alert-info">
                        ...
                        <small>This covers the submission and processing of VNIN Slip requests.</small>
                    </div>
                    ...
                    <div class="tab-content"
                        ...
                        <div class="tab-pane fade show active"
                            ...
                            <form method="POST"
                                  action="{{ route('user.vnin-slip.store') }}"
