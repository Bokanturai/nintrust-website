...
<div class="card">
                                                    ...
                                                    @else
                                                        <div class="text-center p-4 border-0 rounded-4 bg-light shadow-sm">
                                                            ...
                                                            <form id="verify" method="POST" action="{{ route('user.verify-user') }}">
                                                                ...
                                                                <button type="submit" class="btn btn-primary btn-lg w-100 rounded-pill shadow-sm submit-btn">
 ...
 @if (!$users->isEmpty())
                                                 ...
                                                 <ul class="list-unstyled virtual-account-list mt-3 mb-0">
                                                    ...
                                                    @else
                                                        <div class="text-center p-4 border-0 rounded-4 bg-light shadow-sm">
                                                            ...
                                                            <h6 class="fw-bold mb-2">Setup Instant Funding</h6>
                                                            <p class="text-muted small mb-4">
                                                                Please provide your 11-digit BVN below to generate your personal virtual account.
                                                            </p>
                                                            
                                                            <form class="verify-form" method="POST" action="{{ route('user.verify-user') }}">
                                                                @csrf
                                                                <div class="mb-3">
                                                                    <div class="input-group">
                                                                        <span class="input-group-text bg-white border-end-0">
    ...
    document.querySelectorAll('.verify-form, #verify').forEach(form => {
